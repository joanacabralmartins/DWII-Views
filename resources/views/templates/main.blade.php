...
<html lang="pt-br">
    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-md navbar-light" style="background-color: #429893;">
            <div class="container-fluid">
                <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
                        ...
                        <span class="ms-2 fs-5">VetClin</span>
                </a>
        ...
        <nav class="navbar fixed-bottom navbar-light" style="background-color: #429893;">
            <div class="container-fluid">
